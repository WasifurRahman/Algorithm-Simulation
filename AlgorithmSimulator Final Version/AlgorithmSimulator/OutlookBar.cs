...
namespace AlgorithmSimulator
{
    ...
    public class OutlookBar : Panel
    {
        ...
        public static TabControl myTabControl;
        ...
        public OutlookBar(TabControl mtc)
        {
            buttonHeight = 40;
            selectedBand = 0;
    ...
    internal class BandButton : Button
    {
        ...
        private void SelectBand(object sender, EventArgs e)
        {
            ...
            if (bti.index == 0) //File button clicked
            {
                OutlookBar.myTabControl.SelectedIndex = 0; //show banner panel
            }
            else if (bti.index == 1) //Insertion sort button clicked
            {
                OutlookBar.myTabControl.SelectedIndex = 1;
            }
            else if (bti.index == 2) //bubble sort button clicked
            {
                OutlookBar.myTabControl.SelectedIndex = 2;
            }
            else if (bti.index == 3) //selection sort button clicked
            {
                OutlookBar.myTabControl.SelectedIndex = 3;
            }
